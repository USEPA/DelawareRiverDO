...
# Reduce data to daily averages
# dat.fma <- dat.fma %>% 
#   select(zone,datetime,J,NH34,NO23) %>% 
#   mutate(date = as.Date(format(datetime,format="%Y-%m-%d"))) %>% 
#   group_by(zone,J,date) %>% 
#   summarize(NH34 = mean(NH34),
#             NO23 = mean(NO23))

# Save the data to a file.
#save(dat.fma,file=here("data","7.08 Nitrogen from HADO.Rdata"))
...
load(here("data","7.08 Nitrogen from HADO.Rdata"))
