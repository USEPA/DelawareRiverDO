...
#     file=here("data","5.03 Chester Cohort Simulation 2002-2022.Rdata"))
...
pdf(file=here("figures","5.03 Predicted fish weight at Chester.pdf"),
     width=6.5,height=6,paper="letter")
  plt
dev.off()
