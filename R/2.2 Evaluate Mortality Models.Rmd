...
#save(fit.mortality,file=here("data","2.2 fit.mortality.v2.Rdata")
...
pdf(file=here("figures","2.2 Mortality rate vs POSAT and WT.pdf"),width=5,height=5, paper="letter")
  plt
dev.off()
```
...
pdf(file=here("figures","2.2 Confidence intervals for predicted Zmin.pdf"), width=6, height=4, paper="letter")
  plt
dev.off()
