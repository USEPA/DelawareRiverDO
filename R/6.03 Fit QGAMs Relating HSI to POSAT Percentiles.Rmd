...
save(q.predictions.POSAT,file=here("data","6.03 Predicted PP and POSAT percentiles.Rdata"))

# Export data for CSV
write.csv(df.pred,file=here("outputs","6.03 Predicted PP and POSAT percentiles.csv"))
...
pdf(file=here("figures","6.03 HSI vs. POSAT quantiles.pdf"),
...
pdf(file=here("figures","6.03 HSI vs. POSAT Combined quantiles.pdf"),
...
pdf(file=here("figures","6.03 HSI vs. DO Combined quantiles (zoomed).pdf"),
    width=6,height=4,paper="letter")
  plt
dev.off()
